...
def install_circus2(circus_env=None, circus_cmd=None, circus_args=None, circus_name=None, circus_home=None,
                    circus_venv='/opt/venvs/circus', remote_user='ubuntu', virtual_env=None,
                    use_sudo=False, *args, **kwargs):
    if circus_cmd is None or circus_args is None or circus_name is None or circus_home is None:
